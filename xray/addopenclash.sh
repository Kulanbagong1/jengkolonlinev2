...
export patchnontls=/jengkolonline-openclash
...
EOF
cat > /etc/xray/$user-open-clash-443.yaml <<-END
proxies:
  - {name: $user, server: ${domain}, port: 443, type: trojan, password: $uuid, sni: $sni, skip-cert-verify: true, udp: true}
...
cat /etc/openvpn/server/cll.key >> /etc/xray/$user-open-clash-443.yaml

# // Copy config Yaml client ke home directory root agar mudah didownload ( YAML )
cp /etc/xray/$user-open-clash-443.yaml /home/vps/public_html/$user-open-clash-443.yaml
#Open clash 80
cat > /etc/xray/$user-open-clash-80.yaml <<-END
...
proxies:
  - {name: $user, server: ${domain}, port: $none, type: vmess, uuid: $uuid, alterId: 0, cipher: auto, tls: false, network: ws, ws-path: $patchnontls, ws-headers: {Host: $sni}}
proxy-groups:
  - name: ðŸš€ èŠ‚ç‚¹é€‰æ‹©
    type: select
    proxies:
...
END
# // masukkan payloadnya ke dalam config yaml
cat /etc/openvpn/server/cll.key >> /etc/xray/$user-open-clash-80.yaml

# // Copy config Yaml client ke home directory root agar mudah didownload ( YAML )
cp /etc/xray/$user-open-clash-80.yaml /home/vps/public_html/$user-open-clash-80.yaml
...
echo -e "OpenClash W : 443"
echo -e "OpenClash N : 80"
#echo -e "Port GRPC   : 443"
echo -e "User ID     : ${uuid}"
echo -e "Alter ID    : 0"
echo -e "Security    : auto"
#echo -e "Network     : ws"
echo -e "Path        : /jengkolonline-openclash"
#echo -e "Path GRPC   : vmess-grpc"
echo -e "Created     : $hariini"
echo -e "Expired     : $exp"
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "Link OPC 443: http://$MYIP:81/$user-open-clash-443.yaml"
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "Link OPC 80 : http://$MYIP:81/$user-open-clash-80.yaml"
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
