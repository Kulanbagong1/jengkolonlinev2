...
xrayvless1="vless://${uuid}@${domain}:$tls?path=/DecrytorId&security=tls&encryption=none&type=ws#${user}"
xrayvless2="vless://${uuid}@${domain}:$nontls?path=/DecrytorId&encryption=none&type=ws#${user}"
